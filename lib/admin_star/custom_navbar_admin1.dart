...
class custom_bottom_navbar_admin1 extends StatefulWidget {
   final String ? email;
  const custom_bottom_navbar_admin1({required this.email, Key? key}) : super(key: key);

  @override
  State<custom_bottom_navbar_admin1> createState() => _custom_bottom_navbar_admin1State();
}

class _custom_bottom_navbar_admin1State extends State<custom_bottom_navbar_admin1> with SingleTickerProviderStateMixin {
  int selectedIndex = 0;
