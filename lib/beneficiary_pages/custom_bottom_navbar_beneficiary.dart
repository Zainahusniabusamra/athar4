...
import 'package:flutter_application_athar_project/beneficiary_pages/beneficiary_profile.dart';
...
class CustomBottomNavbarBeneficiary extends StatefulWidget {
  final String? email;
  const CustomBottomNavbarBeneficiary({Key? key, required this.email}) : super(key: key);

  @override
  State<CustomBottomNavbarBeneficiary> createState() => CustomBottomNavbarBeneficiaryState();
}

class CustomBottomNavbarBeneficiaryState extends State<CustomBottomNavbarBeneficiary> with SingleTickerProviderStateMixin {
  int selectedIndex = 0;
  ...
  void initState() {
    super.initState();
    widgetBuilder = [
      BeneficiaryProfilePage(email: widget.email),
      adminPage(),
      ourProgramPage(),
      homePage(),
    ];
