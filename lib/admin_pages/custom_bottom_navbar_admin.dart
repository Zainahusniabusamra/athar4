...
class custom_bottom_navbar_admin extends StatefulWidget {
   final String ? email;
  const custom_bottom_navbar_admin({required this.email, Key? key}) : super(key: key);

  @override
  State<custom_bottom_navbar_admin> createState() => _custom_bottom_navbar_adminState();
}

class _custom_bottom_navbar_adminState extends State<custom_bottom_navbar_admin> with SingleTickerProviderStateMixin {
  int selectedIndex = 0;
