...
class custom_bottom_navbar_admin3 extends StatefulWidget {
   final String ? email;
  const custom_bottom_navbar_admin3({required this.email, Key? key}) : super(key: key);

  @override
  State<custom_bottom_navbar_admin3> createState() => _custom_bottom_navbar_admin3State();
}

class _custom_bottom_navbar_admin3State extends State<custom_bottom_navbar_admin3> with SingleTickerProviderStateMixin {
  int selectedIndex = 0;
