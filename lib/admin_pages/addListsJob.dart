...
class Addlistsjob extends StatefulWidget {
  @override
  _AddlistsjobState createState() => _AddlistsjobState();
}

class _AddlistsjobState extends State<Addlistsjob> {
  ...
  Future<void> fetchAdmins() async {
    try {
      var response = await http.get(
        Uri.parse('http://192.168.1.140:3000/user/admins?title=${'اضافة قوائم'}'),
      );
