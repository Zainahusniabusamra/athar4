...
import 'package:flutter_application_athar_project/admin_pages/admin_profile.dart';
import 'package:flutter_application_athar_project/admin_pages/page2.dart';



class custom_bottom_navbar_admin2 extends StatefulWidget {
   final String ? email;
  const custom_bottom_navbar_admin2({required this.email, Key? key}) : super(key: key);

  @override
  State<custom_bottom_navbar_admin2> createState() => _custom_bottom_navbar_admin2State();
}

class _custom_bottom_navbar_admin2State extends State<custom_bottom_navbar_admin2> with SingleTickerProviderStateMixin {
  int selectedIndex = 0;
